...
(function(e) {
    e.fn.collagePlus = function(t) {
        function n(t, n, i, s) {
            ...
            for (var c = 0; c < t.length; c++) {
                ...
                f += p;
                if (!v && f < i.albumWidth) { if (i.allowPartialLastRow === true && l === true) { p = p } else { p = p + (i.albumWidth - f) } }
                p--;
                var m = h.is("img") ? h : h.find("img");
                m.width(p);
                if (!h.is("img")) { h.width(p + t[c][3]) }
                m.height(d);
                if (!h.is("img")) { h.height(d + t[c][4]) }
                r(h, v, i);
                m.one("load", function(e) {
                    return function() {
                        if (i.effect == "default") { e.animate({ opacity: "1" }, { duration: i.fadeSpeed }) } else {
                            if (i.direction == "vertical") { var t = s <= 10 ? s : 10 } else { var t = c <= 9 ? c + 1 : 10 }
                            e.removeClass(function(e, t) { return (t.match(/\beffect-\S+/g) || []).join(" ") });
                            e.addClass(i.effect);
                            e.addClass("effect-duration-" + t)
                        }
                    }
                }(h)).each(function() { if (this.complete) e(this).trigger("load") })
            }
        }

        function r(e, t, n) { var r = { "margin-bottom": n.padding + "px", "margin-right": t ? n.padding + "px" : "0px", display: n.display, "vertical-align": "bottom", overflow: "hidden" }; return e.css(r) }
    ...
    e.fn.collagePlus.defaults = { targetHeight: 400, fadeSpeed: "fast", display: "inline-block", effect: "default", direction: "vertical", allowPartialLastRow: false }
})(jQuery);
...
var Intense = function() {
    ...
    function p(a, b) { for (var c in b) c in a || (a[c] = b[c]); return a }

    function q(a, b) { for (var c in b) a.style[c] = b[c] }

    function r(a) { var b = window.innerHeight / a.h; if (a.w * b > window.innerWidth) return { w: a.w * b, h: a.h * b, fit: !0 }; var c = window.innerWidth / a.w; return { w: a.w * c, h: a.h * c, fit: !1 } }
    ...
    function t(a) {
        (a.getAttribute("data-image") || a.src || a.href) && a.addEventListener("click", function(b) { "A" === a.tagName && b.preventDefault(), o || D(this) }, !1)
    }

    function u() { w() }

    function v() { cancelRequestAnimFrame(e) }

    function w() { e = requestAnimFrame(w), J() }

    function x() { n = document.body.style.overflow, document.body.style.overflow = "hidden" }

    function y() { document.body.style.overflow = n }
    ...
    function D(a) {
        ...
        var b = a.getAttribute("data-image") || a.src || a.href,
            ...
            e = new Image;
        e.onload = function() { h = { w: e.width, h: e.height }, i = this, A(c, d), x(), E(), w(), z(a, "intense--viewing") }, e.src = b
    }

    function E() { k.addEventListener("mousemove", G, !1), k.addEventListener("touchmove", H, !1), window.addEventListener("resize", C, !1), window.addEventListener("keyup", I, !1), i.addEventListener("click", B, !1) }

    function F() { k.removeEventListener("mousemove", G, !1), k.removeEventListener("touchmove", H, !1), window.removeEventListener("resize", C, !1), window.removeEventListener("keyup", I, !1), i.removeEventListener("click", B, !1) }

    function G(a) { b.xDest = a.clientX, b.yDest = a.clientY }

    function H(a) { a.preventDefault(), b.xDest = a.touches[0].clientX, b.yDest = a.touches[0].clientY }

    function I(b) { b.preventDefault(), b.keyCode === a && B() }

    function J() {
        function e(a, b) { return d ? (b - a) / b : a / b }
    ...
    function K(a) { "invertInteractionDirection" in a && (d = a.invertInteractionDirection) }
    ...
    var e, f, h, i, k, n, a = 27,
        b = { xCurr: 0, yCurr: 0, xDest: 0, yDest: 0 },
        c = !0,
        d = !1,
        g = 0,
        j = { w: 0, h: 0 },
        ...
        m = { x: 0, y: 0 },
        o = !1;
    return p(L, { resize: C, start: u, stop: v, config: K })
}();
    ...
    var e = {
        ...
        _determineUrl: function() {
            var i, s = e._verifyDataUrl(e._determineLinkTarget()),
                n = 0,
                a = 0;
            return t.each(s, function(t, s) { e._devicePixelRatio() >= s.density && s.density >= a && e._matchMedia()("screen and (min-width:" + s.width + "px)") && s.width >= n && (n = s.width, a = s.density, i = s.url) }), i
        },
        ...
        isSlideshowEnabled: function() { return e.objectData.isPartOfSequence && (e.settings.slideshow === !0 || e.objectData.isPartOfSequenceWithSlideshow === !0) },
        ...
        _createObject: function() {
            ...
            switch (e.objectData.type) {
                case "image":
                    ...
                    break;
                case "inline":
                    i = t('<div class="' + e.settings.classPrefix + 'inlineWrap"></div>'), i.html(e._cloneObject(t(e.objectData.url))), t.each(e.settings.inline, function(t, s) { i.attr(e._prefixAttributeName(t), s) });
                    break;
                case "ajax":
                ...
                case "flash":
                    ...
                    break;
                case "video":
                    i = t("<video></video>"), i.attr("src", e.objectData.url), t.each(e.settings.video, function(t, e) { i.attr(t, e) });
                    break;
                default:
                    i = t("<iframe></iframe>"), i.attr({ src: e.objectData.url }), t.each(e.settings.iframe, function(t, e) { i.attr(t, e) })
            }
            e._addObject(i), e._loadObject(i)
        },
        _addObject: function(t) { e.objects.contentInner.html(t), e._loading("start"), e._callHooks(e.settings.onStart), e.settings.showSequenceInfo === !0 && e.objectData.isPartOfSequence ? (e.objects.sequenceInfo.html(e.objectData.sequenceInfo), e.objects.sequenceInfo.show()) : (e.objects.sequenceInfo.empty(), e.objects.sequenceInfo.hide()), e.settings.showTitle === !0 && void 0 !== e.objectData.title && "" !== e.objectData.title ? (e.objects.title.html(e.objectData.title), e.objects.title.show()) : (e.objects.title.empty(), e.objects.title.hide()), e.settings.showCaption === !0 && void 0 !== e.objectData.caption && "" !== e.objectData.caption ? (e.objects.caption.html(e.objectData.caption), e.objects.caption.show()) : (e.objects.caption.empty(), e.objects.caption.hide()) },
        _loadObject: function(i) {
            switch (e.objectData.type) {
                case "inline":
                    ...
                    break;
                case "ajax":
                    t.ajax(t.extend({}, e.settings.ajax, { url: e.objectData.url, type: e.objectData.requestType, dataType: e.objectData.requestDataType, data: e.objectData.requestData, success: function(t, s, n) { "json" === e.objectData.requestDataType ? e.objectData.data = t : i.html(t), e._showContent(i) }, error: function(t, i, s) { e.error() } }));
                    break;
                case "flash":
                    e._showContent(i);
                    break;
                case "video":
                    ...
                    break;
                default:
                    e.objectData.url ? (i.load(function() { e._showContent(i) }), i.error(function() { e.error() })) : e.error()
            }
        },
        error: function() {
        ...
        _adjustDimensions: function(t, i) { t.css({ width: i.objectWidth, height: i.objectHeight, "max-width": i.maxWidth, "max-height": i.maxHeight }), e.objects.contentInner.css({ width: t.outerWidth(), height: t.outerHeight(), "max-width": "100%" }), e.objects["case"].css({ width: e.objects.contentInner.outerWidth() }), e.objects["case"].css({ "margin-top": parseInt(-(e.objects["case"].outerHeight() / 2)), "margin-left": parseInt(-(e.objects["case"].outerWidth() / 2)) }) },
        ...
        _verifyDataUrl: function(t) { return t && void 0 !== t && "" !== t ? (t.indexOf("#") > -1 && (t = t.split("#"), t = "#" + t[t.length - 1]), e._normalizeUrl(t.toString())) : !1 },
        ...
        _addElements: function() { "undefined" != typeof e.objects["case"] && t("#" + e.objects["case"].attr("id")).length || e.settings.markup() },
        ...
        _processContent: function() {
            switch (e.isBusy = !0, e.settings.transitionOut) {
                ...
                case "scrollVertical":
                case "scrollHorizontal":
                    e.objects["case"].is(":hidden") ? (e.transition.fade(e.objects["case"], "out", 0, 0, function() { e._loadContent() }), e.transition.fade(e.objects.contentInner, "out", 0)) : e.transition.scroll(e.objects["case"], "out", e.settings.speedOut, function() { e._loadContent() });
                    break;
                case "fade":
        ...
        _startTimeout: function() { e.objects.play.hide(), e.objects.pause.show(), e.cache.action = "next", e.objects.nav.removeClass(e.settings.classPrefix + "paused"), e.timeout = setTimeout(function() { e.objects.nav.data("items").next.click() }, e.settings.timeout) },
        ...
        item: { isFirst: function() { return 0 === e.objectData.currentIndex }, isLast: function() { return e.objectData.currentIndex === e.objectData.sequenceLength - 1 } },
        ...
        transition: {
            fade: function(t, i, s, n, a) {
                var o = "in" === i,
                    ...
                    l = {},
                    d = n ? n : o ? 1 : 0;
                (e.isOpen || !o) && (c.opacity = r, l.opacity = d, t.css(c).show(), e.support.transitions ? (l[e.support.transition + "transition"] = s + "ms ease", setTimeout(function() { t.css(l), setTimeout(function() { t.css(e.support.transition + "transition", ""), !a || !e.isOpen && o || a() }, s) }, 15)) : (t.stop(), t.animate(l, s, a)))
            },
            scroll: function(t, i, s, n) {
                ...
                if (e.isOpen || !a) {
                    ...
                    r.opacity = l, r[c] = d, u.opacity = h, u[c] = f, t.css(r).show(), e.support.transitions ? (u[e.support.transition + "transition"] = s + "ms ease", setTimeout(function() { t.css(u), setTimeout(function() { t.css(e.support.transition + "transition", ""), !n || !e.isOpen && a || n() }, s) }, 15)) : (t.stop(), t.animate(u, s, n))
                }
            },
            zoom: function(t, i, s, n) {
                ...
                (e.isOpen || !a) && (o.opacity = c, o[e.support.transition + "transform"] = r, l.opacity = d, t.css(o).show(), e.support.transitions ? (l[e.support.transition + "transform"] = u, l[e.support.transition + "transition"] = s + "ms ease", setTimeout(function() { t.css(l), setTimeout(function() { t.css(e.support.transition + "transform", ""), t.css(e.support.transition + "transition", ""), !n || !e.isOpen && a || n() }, s) }, 15)) : (t.stop(), t.animate(l, s, n)))
            }
        },
        ...
        resize: function() { e.isOpen && (e.isSlideshowEnabled() && e._stopTimeout(), e.dimensions = e.getViewportDimensions(), e._calculateDimensions(e.cache.object)) },
        ...
        _watchScrollInteraction: function() { t(window).scroll(e._cacheScrollPosition) },
        _unwatchScrollInteraction: function() { t(window).off("scroll", e._cacheScrollPosition) },
        _restoreScrollPosition: function() { t(window).scrollTop(parseInt(e.cache.scrollPosition.top)).scrollLeft(parseInt(e.cache.scrollPosition.left)).resize() },
